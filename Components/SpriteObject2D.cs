...
public class SpriteObject2D : Object2D
{
    ...
    protected virtual RectF? FrameRectangle => SourceRect;
    ...
    protected override void OnRender()
    {
        ...
        RectF source = FrameRectangle ?? _sprite.SourceRect;
        ...
        RenderContext.Current.DrawTexture(_sprite.Texture, source, new RectF(0, 0, width, height), Origin, 0, Tint);
    }
