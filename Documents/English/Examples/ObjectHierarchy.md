...
Child objects inherit their parent's position, rotation, and scale. This makes
attached weapons, wheels, orbiting bodies, and multi-part characters easy to
build.
...
Rotating the star moves the planet around it. Rotating the planet moves the moon
around the planet. Destroying the star also destroys all of its children.
